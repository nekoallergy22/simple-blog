...
export default async function PostPage({ params }: PostPageProps) {
  try {
    ...
    const previousPost =
      currentIndex > 0 ? sectionPosts[currentIndex - 1] : null;
    const nextPost =
      currentIndex < sectionPosts.length - 1
        ? sectionPosts[currentIndex + 1]
        : null;
    ...
    const jsonLd = {
      ...
      publisher: {
        ...
        logo: {
          "@type": "ImageObject",
          url: "https://techmaster.dev/logo.svg",
        },
      },
      ...
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": `https://techmaster.dev/ai/posts/${post.slug}`,
      },
      articleSection: "AI学習",
