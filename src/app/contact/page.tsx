...
export const metadata: Metadata = {
  title: "お問い合わせ・サポート",
  description:
    "Tech-Masterのお問い合わせ、よくある質問、プライバシーポリシー、利用規約について",
};
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="text-lg font-medium text-blue-600">
              <a
                href="mailto:contact@techmaster.dev"
                className="hover:underline"
              >
                contact@techmaster.dev
              </a>
            </p>
          </div>
      ...
      >
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600">
              A.
              はい、Tech-Masterのすべてのコンテンツは無料でご利用いただけます。
          ...
          <div>
            ...
            <p className="text-gray-600">
              A.
              現在は不定期での更新となっておりますが、各セクションのコンテンツを順次充実させていく予定です。
          ...
          <div>
            ...
            <p className="text-gray-600">
              A.
              記事の内容に関するご質問は、上記のお問い合わせメールアドレスまでご連絡ください。
              できる限り丁寧にお答えいたします。
            </p>
          </div>
